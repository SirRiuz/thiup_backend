...
class Command(BaseCommand):
    help = (
        "Seed Reaction and Miniature rows from binaries in media/reactions/ "
        "and media/masks/. Idempotent — skips entries whose `name` already exists."
    )

    SEEDS = (
        ("reactions", "REACTIONS_MEDIA_DIR", Reaction),
